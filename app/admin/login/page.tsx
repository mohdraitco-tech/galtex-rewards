...
export default function AdminLoginPage() {
  ...
  return (
    ...
    >
      <link
        href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Arabic:wght@300;400;500;600;700&family=Space+Grotesk:wght@400;500;600;700&display=swap"
        rel="stylesheet"
      />
      ...
      <span
        style={{
          ...
          width: 320,
          height: 320,
          background: "rgba(22,64,127,0.06)",
          clipPath: star,
      ...
      <div
        style={{
          ...
          borderRadius: 24,
          padding: "44px 40px",
          boxShadow: "0 34px 70px -34px rgba(18,44,92,0.4)",
        }}
      >
        {/* الشعار + العنوان */}
        <div style={{ textAlign: "center", marginBottom: 34 }}>
          <span
            style={{
              display: "inline-flex",
              background: C.beige,
              border: "1px solid rgba(18,44,92,0.08)",
              borderRadius: 18,
              padding: "16px 22px",
              marginBottom: 22,
            }}
          ...
          >
            سجّل الدخول للوصول إلى إدارة النظام
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            style={{
              ...
              width: "100%",
              textAlign: "center",
              background: isLoading ? "#9AA3B5" : C.blue,
              color: C.beige,
              fontWeight: 700,
              fontSize: 16,
              padding: 15,
      ...
      <style>{`
        ...
        .gx-in:focus {
          outline: none;
          border-color: #16407F;
          box-shadow: 0 0 0 3px rgba(22,64,127,0.12);
        }
